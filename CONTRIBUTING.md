...
Fork [MinIO upstream](https://github.com/memoio/miniofork) source repository to your own personal repository. Copy the URL of your MinIO fork (you will need it for the `git clone` command below).
