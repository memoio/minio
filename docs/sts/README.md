...
| AuthN                                                                                  | Description                                                                                                                                   |
| :----------------------                                                                | ------------------------------------------                                                                                                    |
| [**WebIdentity**](https://github.com/memoio/minioblob/master/docs/sts/web-identity.md) | Let users request temporary credentials using any OpenID(OIDC) compatible web identity providers such as KeyCloak, Dex, Facebook, Google etc. |
| [**AD/LDAP**](https://github.com/memoio/minioblob/master/docs/sts/ldap.md)             | Let AD/LDAP users request temporary credentials using AD/LDAP username and password.                                                          |
| [**AssumeRole**](https://github.com/memoio/minioblob/master/docs/sts/assume-role.md)   | Let MinIO users request temporary credentials using user access and secret keys.                                                              |
...
>
> - [**AssumeRole**](https://github.com/memoio/minioblob/master/docs/sts/assume-role.md)
> - [**AD/LDAP**](https://github.com/memoio/minioblob/master/docs/sts/ldap.md)
...
> NOTE: If you are interested in AssumeRole API only, skip to [here](https://github.com/memoio/minioblob/master/docs/sts/assume-role.md)

### Prerequisites

- [Configuring keycloak](https://github.com/memoio/minioblob/master/docs/sts/keycloak.md) or [Configuring Casdoor](https://github.com/memoio/minioblob/master/docs/sts/casdoor.md)
- [Configuring etcd (optional needed only in gateway or federation mode)](https://github.com/memoio/minioblob/master/docs/sts/etcd.md)
