...
to set it up refer to our [KMS Guide](https://github.com/memoio/minio/blob/master/docs/kms/README.md).
...
- For instructions on using KES for encrypting the MinIO backend, follow the [KMS Quick Start](https://github.com/memoio/minio/tree/master/docs/kms). The SSE-S3 configuration setup also supports MinIO KMS backend encryption.
