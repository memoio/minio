...
More details about supported KMS implementations and configuration can be found at the [KMS guide](https://github.com/memoio/minioblob/master/docs/kms/README.md).
