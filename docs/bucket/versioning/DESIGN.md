...
A sample msgpack-JSON `xl.meta`, you can debug the content inside `xl.meta` using [xl-meta.go](https://github.com/memoio/miniotree/master/docs/debugging#decoding-metadata) program.
