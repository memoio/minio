...
[Using minio-go library](https://github.com/memoio/minioblob/master/docs/extensions/s3zip/examples/minio-go/main.go)
[Using AWS JS SDK v2](https://github.com/memoio/minioblob/master/docs/extensions/s3zip/examples/aws-js/main.js)
[Using boto3](https://github.com/memoio/minioblob/master/docs/extensions/s3zip/examples/boto3/main.py)
