...
Refer the [document here to setup Grafana with MinIO prometheus metrics](https://github.com/memoio/minioblob/master/docs/metrics/prometheus/grafana/README.md).
...
[The list of metrics reported can be here](https://github.com/memoio/minioblob/master/docs/metrics/prometheus/list.md)
