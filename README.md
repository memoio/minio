...
[![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io) [![Docker Pulls](https://img.shields.io/docker/pulls/minio/minio.svg?maxAge=604800)](https://hub.docker.com/r/minio/minio/) [![license](https://img.shields.io/badge/license-AGPL%20V3-blue)](https://github.com/memoio/minioblob/master/LICENSE)
...
Please follow MinIO [Contributor's Guide](https://github.com/memoio/minioblob/master/CONTRIBUTING.md)

## License

- MinIO source is licensed under the GNU AGPLv3 license that can be found in the [LICENSE](https://github.com/memoio/minioblob/master/LICENSE) file.
- MinIO [Documentation](https://github.com/memoio/miniotree/master/docs) © 2021 by MinIO, Inc is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
- [License Compliance](https://github.com/memoio/minioblob/master/COMPLIANCE.md)
