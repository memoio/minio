...
import (
	...
	"github.com/memoio/miniointernal/s3select/csv"
	"github.com/memoio/miniointernal/s3select/json"
	"github.com/memoio/miniointernal/s3select/parquet"
	"github.com/memoio/miniointernal/s3select/simdj"
